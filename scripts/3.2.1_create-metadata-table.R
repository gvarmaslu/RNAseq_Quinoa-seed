...
# R CMD BATCH 4.2.1_create-metadata-table.R
...
# Read CSV into R
MyData <- read.csv(file="/home/gala0002/proj/proj_dir/NG-14833_4.2_express_combine-all/Express_counts_all_Pas-Reg-Tit_summary.csv", header=TRUE,check.names=FALSE, sep=",")
...
write.table(metadata_ad, file="/home/gala0002/proj/proj_dir/NG-14833_4.2_express_combine-all/Express_counts_all_Pas-Reg-Tit_metadata_all.txt", row.names=F, sep="\t", quote=FALSE)
