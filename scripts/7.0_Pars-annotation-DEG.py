...
#python 7.0_Pars-annotation-DEG.py PasvReg_results_Filt_PValue-0.01_head.csv PasvReg_results_Filt_PValue-0.01_anno.tsv /home/gala0002/proj/proj_dir/NG-14833_4.4_EdgeR_results_anno/
...
class SearchDB(fileHandler):
	...
	def Search_ReMM(self,readfl1,outfl1,workdir):
		...
		with open(workdir+readfl1,'r') as f1, open(workdir+outfl1,'w') as output:
			first_line0 = f1.readline().strip().split(",")[1:]
