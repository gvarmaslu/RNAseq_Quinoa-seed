...
def main():
    ...
    star_genome_generate_cmd = str("STAR --runThreadN " +
                                   ...
                                   " --limitSjdbInsertNsj 2000000 " + # added by Varma
    ...
    #     Pipeliner.Command("/usr/lib/jvm/java-8-openjdk-amd64/bin/java -Xmx200g -jar " + GATK_HOME + "/GenomeAnalysisTK.jar " + # added by Varma
