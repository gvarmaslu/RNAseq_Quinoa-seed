...
#./1.3_rRNA-and-AdaptRM_QC.sh > 1.3_rRNA-and-AdaptRM_QC.sh.log 2>&1
...
mkdir -p ${work_dir}NG-14833_1.2_sort-trim_Merge_QC/
out_dir=${work_dir}NG-14833_1.2_sort-trim_Merge_QC/
...
gunzip -c ${work_dir}NG-14833_1.1_sort-trim/${nbr}${nbr1}-sortmerna-trimmomatic_1.fq.gz > ${temp_dir}${nbr1}-L1_1.fq
gunzip -c ${work_dir}NG-14833_1.1_sort-trim/${nbr}${nbr1}-sortmerna-trimmomatic_2.fq.gz > ${temp_dir}${nbr1}-L1_2.fq
